...
a.currentDay?u:b;j=!h?j:this.formatDate(j,r,this._getFormatConfig(a));h=!a.inline?'<button type="button" class="bidButton" style="float:right; margin-bottom:5px;" onclick="DP_jQuery_'+z+'.datepicker._hideDatepicker();">'+this._get(a,"closeText")+"</button>":"";e=e?'<div class="ui-datepicker-buttonpane">'+(c?h:"")+(this._isInRange(a,r)?'<button type="button" class="bidButton" onclick="DP_jQuery_'+
