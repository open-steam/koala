<?php
	...
	define("PLATFORM_ID", "koala");
	// plattform name
	define("PLATFORM_NAME", "e-lab");
	//displayed in browser title
	define("PLATFORM_TITLE", "e-lab");	
	...
	define( "MAINTAINANCE_MESSAGE", "Das e-lab System wird zur Zeit gewartet, dies wird voraussichtlich 20 Minuten in Anspruch nehmen.<br /> Bitte haben Sie etwas Geduld und versuchen es später noch einmal.");
	...
	*/
	...
	define("YOU_MENU", TRUE); //the hole you menu.
		...
		define("MAILBOX_SHOW_UNREAD_ON_STARTPAGE", FALSE);
	...
	define("SUPPORT_EMAIL", "elearning@uni-paderborn.de");
	
	define("SYSTEMCONFIG_FUNCTION_MAIL", TRUE); // FALSE disables mail function for the whole system 
