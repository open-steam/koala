        ...
        try {
            switch ($errorCode) {
                ...
                case E_USER_ACCESS_DENIED:
                    ...
                    $frameResponseObject->setProblemDescription(gettext("You have not the required rights to execute this action. Please consult the owner of the object for further information.") . "<br /><br /><a href=\"" . (isset($_SERVER[ "HTTP_REFERER" ]) ? $_SERVER[ "HTTP_REFERER" ] : PATH_SERVER) . "\">" . gettext( "back" ) . "</a>");
                break;
