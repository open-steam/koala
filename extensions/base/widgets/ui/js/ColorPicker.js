...
(function (window, $, undefined) {
            ...
            "<div class='sp-container'>",
                ...
                "<div class='sp-picker-container'>",
                    ...
                    "<div class='sp-button-container sp-cf'>",
                        "<a class='bidButton negative' style='margin-right:5px; margin-top:5px; float:left;' href='#'></a>",
                        "<button class='bidButton choose' style='margin-top:5px; float:right;'></button>",
                    "</div>",
                "</div>",
            "</div>"
        ].join("");
    ...
    function spectrum(element, o) {
        ...
        var doc = element.ownerDocument,
            ...
            cancelButton = container.find(".bidButton.negative"),
            chooseButton = container.find(".bidButton.choose"),
