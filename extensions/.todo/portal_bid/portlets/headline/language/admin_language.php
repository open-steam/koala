...
//  require_once("$config_doc_root/classes/debugHelper.php");
  ...
  $portlet_doc_root = "$config_doc_root/modules/portal2/portlets/headline";
  ...
  foreach($languages as $language)
  {
    ...
    $tpl->set_block("language", "edit_feedback_headline_null");
    $tpl->set_block("language", "edit_headline");
    $tpl->set_block("language", "edit_alignment");
    $tpl->set_block("language", "edit_alignment_left");
    $tpl->set_block("language", "edit_alignment_center");
    $tpl->set_block("language", "edit_alignment_right");
    $tpl->set_block("language", "edit_size");
    ...
    $tpl->parse("LANGUAGE_FEEDBACK_HEADLINE_NULL", "edit_feedback_headline_null");
    $tpl->parse("LANGUAGE_HEADLINE", "edit_headline");
    $tpl->parse("LANGUAGE_ALIGNMENT", "edit_alignment");
    $tpl->parse("LANGUAGE_ALIGNMENT_LEFT", "edit_alignment_left");
    $tpl->parse("LANGUAGE_ALIGNMENT_CENTER", "edit_alignment_center");
    $tpl->parse("LANGUAGE_ALIGNMENT_RIGHT", "edit_alignment_right");
    $tpl->parse("LANGUAGE_SIZE", "edit_size");
