...
require_once( PATH_EXTENSIONS . "units_extern/classes/koala_object_docextern.class.php");
...
class units_extern extends koala_unit
{
	...
	function get_headline( $headline = array(), $context = "", $params = array() )
	{
		...
		if ( !($params["unit"]->get_attribute("OBJ_TYPE") === "docextern_unit_koala") ) return FALSE;
