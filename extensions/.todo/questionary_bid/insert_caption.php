<?php
  ...
  /****************************************************************************
  insert_caption.php - create a caption field in a questionary
  Copyright (C)
  ...
  ****************************************************************************/
  ...
  if($action != "" && isset($_POST["text"]))
  {
    ...
    else
    {
      ...
      else if($action == "insert")
	  {
		...
		//add_caption
	  	$geo = new questionary_geo();
		$geo->add_caption($_POST["text"], $question_id);	
	  }
  ...
  $tpl->set_file("content", "insert_caption.ihtml");
  ...
  {
  	$button_action="edit";
	$button_label="button_edit";
	$url = "$config_webserver_ip/modules/questionary/insert_caption.php?question_id=".$question_id;
  }
  else	
  {
  	$button_action="insert";
	$button_label="button_insert";
	$url = "$config_webserver_ip/modules/questionary/insert_caption.php";
  }
  ...
  $tpl->parse("BUTTON_LABEL", $button_label);
