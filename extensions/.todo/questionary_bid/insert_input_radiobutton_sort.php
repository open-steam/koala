<?php
  ...
  /****************************************************************************
  insert_input_radiobutton_sort.php - sort the radiobutton options in a questionary
  Copyright (C)
  ...
  ****************************************************************************/
  ...
  $tpl->set_file("content", "insert_input_radiobutton_sort.ihtml");
  ...
  $tpl->set_var(array(
    ...
    "BUTTON_CANCEL_URL" => "$config_webserver_ip/modules/questionary/insert_input_radiobutton.php"
  ));

  //parse save button
  $tpl->set_var(array(
    "BUTTON_MISSION" => "sort",
    "BUTTON_URL" => "$config_webserver_ip/modules/questionary/insert_input_radiobutton.php"
  ));
