<?php
class portfolio_html_start extends portfolio_html {

	public function __construct($path = "") {
		parent::__construct(PORTFOLIO_PATH_TEMPLATES . "index.template.html", $path, "start");
	}

	public function set_content(){
		$template = new HTML_TEMPLATE_IT();
		$template->loadTemplateFile(PORTFOLIO_PATH_TEMPLATES . "start.template.html");
