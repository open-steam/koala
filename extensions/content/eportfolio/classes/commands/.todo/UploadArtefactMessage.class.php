...
class UploadArtefactMessage extends \AbstractCommand implements \IFrameCommand, \IIdCommand, \IAjaxCommand {
	...
	public function processData(\IRequestObject $requestObject){
		...
		$dialog->setTitle("Beleg hochladen");
		...
		$imgWidget->setHtml("Um einen Beleg hochzuladen ziehen sie eine Datei auf dieses Feld oder doppelklicken sie hier.<br>");
		...
		$ajaxUploader->setCommand("UploadArtefact");
		$ajaxUploader->setDestId($params["id"]);
//		$ajaxUploader->setDestId(0);
