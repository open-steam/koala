...
class ToggleCompetences extends \AbstractCommand implements \IAjaxCommand {
	...
	public function ajaxResponse(\AjaxResponseObject $ajaxResponseObject) {
            if ($this->params["value"] === "true") {
                $this->entry->addCompetenceString($this->params["competence"]);
            } else {
                $this->entry->removeCompetenceString($this->params["competence"]);
            }
