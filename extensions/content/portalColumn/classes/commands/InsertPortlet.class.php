...
class InsertPortlet extends \AbstractCommand implements \IAjaxCommand {
	...
	public function ajaxResponse(\AjaxResponseObject $ajaxResponseObject) {
		...
		foreach($GLOBALS["STEAM"]->get_current_steam_user()->get_inventory() as $steamObject){
			...
			if( $portletType=="msg" || $portletType=="appointment" || $portletType=="termplan" || $portletType=="topic" || $portletType=="headline" || $portletType=="poll" || $portletType=="media" || $portletType=="rss" || $portletType=="chronic" || $portletType=="userpicture" || $portletType=="folderlist"){
                            $isPortlet=true;
                        }   
