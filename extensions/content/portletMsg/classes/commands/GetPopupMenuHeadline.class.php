...
class GetPopupMenuHeadline extends \AbstractCommand implements \IAjaxCommand {
	...
	public function ajaxResponse(\AjaxResponseObject $ajaxResponseObject) {
		...
		$items = array(	array("name" => "<img src=\"{$editIcon}\">Bearbeiten",  "command" => "Edit", "namespace" => "PortletMsg", "params" => "{'portletId':'{$this->portletObjectId}','user':'{$this->user}'}", "type"=>"popup"),
						array("name" => "<img src=\"{$newIcon}\">Meldung einfügen",  "command" => "CreateNewFormMsg", "namespace" => "PortletMsg", "params" => "{'portletObjectId':'{$this->portletObjectId}'}", "type"=>"popup"),
						...
						array("name" => "<img src=\"{$copyIcon}\">Kopieren",  "command" => "CopyMsg", "namespace" => "PortletMsg", "params" => "{'id':'{$this->portletObjectId}','user':'{$this->user}'}", "type"=>"popup"),
						...
						array("name" => "<img src=\"{$trashIcon}\">Löschen",  "command" => "Delete", "namespace" => "PortletMsg", "params" => "{'portletObjectId':'{$this->portletObjectId}'}", "type"=>"popup"),
