...
class Output extends \AbstractCommand implements \IFrameCommand {
	...
	public function embedContent(\IRequestObject $requestObject) {
		if(isset($_REQUEST['output']) && $_REQUEST['output'] === "inline"){
			return true;
		} else {
			return false;
		}
	...
	public function getHtmlForObjectId(\FrameResponseObject $frameResponseObject){
		...
		foreach ($elements as $element) {
			...
			} else if ($element->get_name() == $_REQUEST["xslName"] . ".xsl") {
