...
class AddAdmin extends \AbstractCommand implements \IFrameCommand {
	...
	public function frameResponse(\FrameResponseObject $frameResponseObject) {
		...
		if ( ! empty( $_REQUEST[ "pattern" ] ) )
		{
			...
			if ( $no_people > 0 ) {
				$paginator = \lms_portal::get_paginator(10, $no_people, "(" . gettext( "%TOTAL people in result set" ) . ")", "?pattern=" . $_REQUEST[ "pattern" ] . "&lookin=" . $_REQUEST[ "lookin" ] . "&group=" . $_REQUEST["group"] . "&backlink=" . $_REQUEST["backlink"]);
