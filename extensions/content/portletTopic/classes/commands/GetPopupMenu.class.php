...
class GetPopupMenu extends \AbstractCommand implements \IAjaxCommand {
    ...
    public function ajaxResponse(\AjaxResponseObject $ajaxResponseObject) {
        ...
        $items = array(array("name" => "<svg><use xlink:href='{$editIcon}#edit'/></svg> Bearbeiten", "command" => "EditTopic", "namespace" => "PortletTopic", "params" => "{'portletId':'{$this->id}'}", "type" => "popup"),
            array("name" => "<svg><use xlink:href='{$newIcon}#newElement'/></svg> Link einfügen", "command" => "CreateCatForm", "namespace" => "PortletTopic", "params" => "{'portletId':'{$this->id}'}", "type" => "popup"),
            ...
            array("name" => "<svg><use xlink:href='{$trashIcon}#trash'/></svg> Löschen", "command" => "Delete", "namespace" => "PortletTopic", "params" => "{'portletId':'{$this->id}'}", "type" => "popup"),
