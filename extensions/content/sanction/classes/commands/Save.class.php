                ...
                if($this->className != null){
                    ...
                    if($this->className == "user"){
                        ...
                        if($user instanceof \Steam_user){
                            ...
                            $ajaxResponseObject->setData("Es wurde kein Nutzer mit dem Namen ".$this->value." gefunden.");
                        }
                        ...
                        if($group instanceof \Steam_group){
                          ...
                          $ajaxResponseObject->setData("Es wurde keine Gruppe mit dem Namen ".$this->value." gefunden.");
                        }
                    }
                }
