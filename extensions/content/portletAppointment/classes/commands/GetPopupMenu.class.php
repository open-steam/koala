...
class GetPopupMenu extends \AbstractCommand implements \IAjaxCommand {
	...
	public function ajaxResponse(\AjaxResponseObject $ajaxResponseObject) {
		...
		$items = array(	array("name" => "<img src=\"{$editIcon}\">Bearbeiten",  "command" => "Edit", "namespace" => "PortletAppointment", "params" => "{'portletId':'{$this->id}'}", "type"=>"popup"),
						array("name" => "<img src=\"{$newIcon}\">Termin anlegen",  "command" => "CreateNewFormTerm", "namespace" => "PortletAppointment", "params" => "{'portletId':'{$this->id}'}", "type"=>"popup"),
						...
						array("name" => "<img src=\"{$referIcon}\">Referenz erstellen",  "command" => "PortletReference", "namespace" => "Portal", "params" => "{'id':'{$this->id}','user':'{$this->user}'}", "type"=>"inform"),
						array("name" => "<img src=\"{$trashIcon}\">Löschen",  "command" => "Delete", "namespace" => "PortletAppointment", "params" => "{'portletId':'{$this->id}'}", "type"=>"popup"),
