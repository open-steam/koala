...
class EditMessageImage extends \AbstractCommand implements \IAjaxCommand {
	...
	public function processData(\IRequestObject $requestObject){
		...
		$ajaxUploader->setNamespace("Rapidfeedback");
		...
		$raw->setHtml(<<<END
		<a href="#" class="button pill negative" onclick="sendRequest('DeleteImage', {'id':{$object->get_id()}}, '', 'data', null, function() {document.getElementById('uploaderImage').src = '{$emptyImageUrl}'; jQuery('#uploaderImage').addClass('saved')}, 'Rapidfeedback');">Bild löschen</a>
END
);
