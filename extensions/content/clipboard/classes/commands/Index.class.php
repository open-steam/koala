...
class Index extends \AbstractCommand implements \IFrameCommand {
	...
	public function frameResponse(\FrameResponseObject $frameResponseObject) {
		...
		$breadcrumb->setData(array("", array("name" => "<img src=\"".PATH_URL."explorer/asset/icons/mimetype/".deriveIcon($object)."\"></img> " . $title . " " . \Explorer\Model\Sanction::getMarkerHtml($object, false))));
