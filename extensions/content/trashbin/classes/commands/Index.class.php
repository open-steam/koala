...
class Index extends \AbstractCommand implements \IFrameCommand, \IAjaxCommand {
	...
	public function frameResponse(\FrameResponseObject $frameResponseObject) {
		...
		$breadcrumb->setData(array("", array("name" => "<svg style='width:16px; height:16px; color:#3a6e9f;' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><use xlink:href='" .  PATH_URL . "explorer/asset/icons/trashbin.svg#trashbin'/></svg>" . $title)));
