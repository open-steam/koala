...
class GetPopupMenuHeadline extends \AbstractCommand implements \IAjaxCommand {
    ...
    public function ajaxResponse(\AjaxResponseObject $ajaxResponseObject) {
        ...
        $items = array(array("name" => "<svg><use xlink:href='{$editIcon}#edit'/></svg> Bearbeiten", "command" => "Edit", "namespace" => "PortletSlideShow", "params" => "{'portletId':'{$this->portletObjectId}','user':'{$this->user}'}", "type" => "popup"),
            ...
            array("name" => "<svg><use xlink:href='{$trashIcon}#trash'/></svg> Löschen", "command" => "Delete", "namespace" => "PortletSlideShow", "params" => "{'portletId':'{$this->portletObjectId}'}", "type" => "popup"),
