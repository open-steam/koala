...
class PortletGetPopupMenuReference extends \AbstractCommand implements \IAjaxCommand {
	...
	public function ajaxResponse(\AjaxResponseObject $ajaxResponseObject) {
		...
		$items = array(	//array("name" => "Portal mit Orginalkomponente anzeigen(geht nicht)",  "command" => "Index", "namespace" => "Portal", "params" => "{'id':'{$this->sourcePortalObjectId}','user':'{$this->user}'}", "type"=>""), 
