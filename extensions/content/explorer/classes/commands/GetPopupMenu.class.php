    ...
    public function ajaxResponse(\AjaxResponseObject $ajaxResponseObject) {
        ...
        if (!in_array($this->id, $this->selection) || (in_array($this->id, $this->selection) && $count == 1)) {
            ...
            foreach ($inventory as $key => $element) {
                if ($element instanceof \steam_user || $element instanceof \steam_trashbin)
                    $counter++;
            ...
            if ($object instanceof \steam_trashbin) {
                ...
                $items = array(
                    ...
                    ($object->check_access(SANCTION_WRITE)) ? array("name" => "<svg><use xlink:href='{$brushIcon}#brush'/></svg> Einfärben", "direction" => "right", "menu" => array(
                        array("raw" => " <a href=\"#\" onclick=\"sendRequest('ChangeColorLabel', {'id':'{$this->id}', 'color':'transparent'}, 'listviewer-overlay', 'nonModalUpdater', null, null, 'explorer'); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='greyColor'><use xlink:href='{$explorerUrl}icons/menu/svg/transparent.svg#transparent'/></svg></a>
                            <a href=\"#\" onclick=\"sendRequest('ChangeColorLabel', {'id':'{$this->id}', 'color':'red'}, 'listviewer-overlay', 'nonModalUpdater', null, null, 'explorer'); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='redColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                            <a href=\"#\" onclick=\"sendRequest('ChangeColorLabel', {'id':'{$this->id}', 'color':'orange'}, 'listviewer-overlay', 'nonModalUpdater', null, null, 'explorer'); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='orangeColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                            <a href=\"#\" onclick=\"sendRequest('ChangeColorLabel', {'id':'{$this->id}', 'color':'yellow'}, 'listviewer-overlay', 'nonModalUpdater', null, null, 'explorer'); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='yellowColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                            <a href=\"#\" onclick=\"sendRequest('ChangeColorLabel', {'id':'{$this->id}', 'color':'green'}, 'listviewer-overlay', 'nonModalUpdater', null, null, 'explorer'); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='greenColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                            <a href=\"#\" onclick=\"sendRequest('ChangeColorLabel', {'id':'{$this->id}', 'color':'blue'}, 'listviewer-overlay', 'nonModalUpdater', null, null, 'explorer'); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='blueColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                            <a href=\"#\" onclick=\"sendRequest('ChangeColorLabel', {'id':'{$this->id}', 'color':'purple'}, 'listviewer-overlay', 'nonModalUpdater', null, null, 'explorer'); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='purpleColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                            <a href=\"#\" onclick=\"sendRequest('ChangeColorLabel', {'id':'{$this->id}', 'color':'grey'}, 'listviewer-overlay', 'nonModalUpdater', null, null, 'explorer'); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='greyColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>"),
                        )) : "",
            ...
            if ($this->logged_in) {
                $items = array(
                    ...
                    ($writeAccess) ? array("name" => "<svg><use xlink:href='{$brushIcon}#brush'/></svg> {$count} Objekte einfärben", "direction" => "right", "menu" => array(
                            array("raw" => " <a href=\"#\" onclick=\"sendMultiRequest('ChangeColorLabel', $paramsArrayFunction({'color':'transparent'}), $ElementIdFunction('listviewer-overlay'), 'updater', null, null, 'explorer', 'Ändere Farbe ...', 0,  $SelectionFunction); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='greyColor'><use xlink:href='{$explorerUrl}icons/menu/svg/transparent.svg#transparent'/></svg></a>
                        <a href=\"#\" onclick=\"sendMultiRequest('ChangeColorLabel', $paramsArrayFunction({'color':'red'}), $ElementIdFunction('listviewer-overlay'), 'updater', null, null, 'explorer', 'Ändere Farbe ...', 0,  $SelectionFunction); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='redColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                        <a href=\"#\" onclick=\"sendMultiRequest('ChangeColorLabel', $paramsArrayFunction({'color':'orange'}), $ElementIdFunction('listviewer-overlay'), 'updater', null, null, 'explorer', 'Ändere Farbe ...', 0,  $SelectionFunction); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='orangeColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                        <a href=\"#\" onclick=\"sendMultiRequest('ChangeColorLabel', $paramsArrayFunction({'color':'yellow'}), $ElementIdFunction('listviewer-overlay'), 'updater', null, null, 'explorer', 'Ändere Farbe ...', 0,  $SelectionFunction); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='yellowColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                        <a href=\"#\" onclick=\"sendMultiRequest('ChangeColorLabel', $paramsArrayFunction({'color':'green'}), $ElementIdFunction('listviewer-overlay'), 'updater', null, null, 'explorer', 'Ändere Farbe ...', 0,  $SelectionFunction); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='greenColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                        <a href=\"#\" onclick=\"sendMultiRequest('ChangeColorLabel', $paramsArrayFunction({'color':'blue'}), $ElementIdFunction('listviewer-overlay'), 'updater', null, null, 'explorer', 'Ändere Farbe ...', 0,  $SelectionFunction); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='blueColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                        <a href=\"#\" onclick=\"sendMultiRequest('ChangeColorLabel', $paramsArrayFunction({'color':'purple'}), $ElementIdFunction('listviewer-overlay'), 'updater', null, null, 'explorer', 'Ändere Farbe ...', 0,  $SelectionFunction); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='purpleColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>
                        <a href=\"#\" onclick=\"sendMultiRequest('ChangeColorLabel', $paramsArrayFunction({'color':'grey'}), $ElementIdFunction('listviewer-overlay'), 'updater', null, null, 'explorer', 'Ändere Farbe ...', 0,  $SelectionFunction); jQuery('.popupmenuwrapper').remove();jQuery('.open').removeClass('open');jQuery('#footer_wrapper').css('padding-top', '0px'); return false;\"><svg class='greyColor'><use xlink:href='{$explorerUrl}icons/menu/svg/color.svg#color'/></svg></a>"),
                        )) : "",
                );
            } else {
                $items = array(array("name" => "Keine Aktionen möglich"));
