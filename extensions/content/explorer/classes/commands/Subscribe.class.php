	...
	public function processData(\IRequestObject $requestObject) {		
		...
		$this->id = $this->params["id"];
                ...
                if ($portal instanceof \steam_object) {
                    ...
                    \ExtensionMaster::getInstance()->callCommand("Create", "PortletSubscription", array("parent" => $column, "objectid" => $this->id, "title" => "Abo: " . getCleanName($object), "type" => "0", "sort" => "0", "version"=>"3.0"));
                }
	}
