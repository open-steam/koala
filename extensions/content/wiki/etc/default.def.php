...
defined("WIKI_FULL_HEADLINE") or define("WIKI_FULL_HEADLINE", false); // only works in group/course structure (will result in warnings/errors otherwise)
...
defined("WIKI_EXPORT") or define("WIKI_EXPORT", true);
