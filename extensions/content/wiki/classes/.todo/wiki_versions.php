...
for( $i = $start; $i < $end; $i++ )
{
	...
	{
		$content->setVariable( "VALUE_ACTION_DELETE", "<a href=\"" . PATH_URL . "wiki/" . $wiki_doc->get_id() . "/versions/" . $doc->get_id() . "/deleteVersion\" onclick=\"return confirmDeletion();\">" . "&raquo; " . gettext("Delete this version") . "</a><br \/>" );
	}
