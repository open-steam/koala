...
class GetPopupMenuHeadline extends \AbstractCommand implements \IAjaxCommand {
	...
	public function ajaxResponse(\AjaxResponseObject $ajaxResponseObject) {
		...
		$items = array(	array("name" => "Bearbeiten <img src=\"{$editIcon}\">",  "command" => "Edit", "namespace" => "PortletSubscription", "params" => "{'portletId':'{$this->portletObjectId}','user':'{$this->user}'}", "type"=>"popup"),
						...
						array("name" => "Referenz erstellen <img src=\"{$referIcon}\">",  "command" => "PortletReference", "namespace" => "Portal", "params" => "{'id':'{$this->id}','user':'{$this->user}'}", "type"=>"inform"), 
						array("name" => "Löschen <img src=\"{$trashIcon}\">",  "command" => "Delete", "namespace" => "PortletSubscription", "params" => "{'portletId':'{$this->portletObjectId}'}", "type"=>"popup"),
						array("name" => "SEPARATOR"),
