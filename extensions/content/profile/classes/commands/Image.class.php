    ...
    public function execute(\FrameResponseObject $frameResponseObject) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_POST["action"]) && $_POST["action"] == "deleteicon") {
                ...
                //$user->set_attribute("OBJ_ICON"); // outcommented because of warning (not sure it works fine now?)
        ...
        if (PLATFORM_ID == "bid") {
            $infoBar->addParagraph("Hier können Sie ein Benutzerbild hinterlegen. Dieses wird beispielsweise an Ihren Dokumenten und Forenbeiträgen zusammen mit Ihrem Namen angezeigt.");
        } else {
        ...
        */
        ...
        $BackToProfileButton->setHtml('<a href="http://' . $_SERVER['HTTP_HOST'] . '/profile/index/" class="pill button" style="margin-top: 150px; margin-left: 810px;">Zurück zum Profil</a>');
