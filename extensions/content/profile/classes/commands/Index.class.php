...
class Index extends \AbstractCommand implements \IFrameCommand {
	...
	public function label_to_mapping( $label )
	{
		switch ( $label )
		{
			...
			case "Beschreibung": 	return "PRIVACY_STATUS";break;
			case "Telefon": 		return "PRIVACY_TELEPHONE";break;
	...
	public function execute (\FrameResponseObject $frameResponseObject) {
		...
		if ( $this->GENERAL_displayed )$GLOBALS["content"]->setVariable( "HEADER_GENERAL_INFORMATION", gettext( "General Information" ) );
		...
		if ( $this->CONTACTS_AND_GROUPS_displayed ) $GLOBALS["content"]->setVariable( "HEADER_CONTACTS_AND_GROUPS", gettext( "Contacts and Groups" ) );
		...
		if ( $this->CONTACT_DATA_displayed )$GLOBALS["content"]->setVariable( "HEADER_CONTACT_DATA", gettext( "Contact Data" ) );
