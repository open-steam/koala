...
class DisplayExercise extends \AbstractCommand implements \IFrameCommand {
    ...
    public function execute(\FrameResponseObject $frameResponseObject) {
        ...
        $breadcrumb->setData(array(array("name" => "&Uuml;bungsaufgaben", "link" => PATH_URL . "exercise/index/" . $this->id), array("name" => "Liste der Aufgaben", "link" => PATH_URL . "exercise/ListExercises/". $this->id), array("name" => $container_name)));

        $actionBar = new \Widgets\ActionBar();
        $actionBar->setActions(array(array("name" => "&Uuml;bung bearbeiten", "link" => PATH_URL . "exercise/CreateExercise/" . $this->id . "/" . $container_name . "/"),));
        ...
        if ($ex_maxg > 1)
            ...
            $tmplt->setVariable("ATTR_GROUP", "nein&nbsp;(Einzelabgabe)");
